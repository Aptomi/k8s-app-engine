...
func (vis PolicyVisualization) getVisualFileNamePNG(suffix string) string {
	return GetAptomiObjectWriteDir(GetAptomiBaseDir(), TypeGraphics) + "/graph_" + suffix + ".png"
}
...
func (vis PolicyVisualization) saveGraph(suffix string, graph *gographviz.Graph) {
	fileNameDot := GetAptomiObjectWriteDir(GetAptomiBaseDir(), TypeGraphics) + "/graph_" + suffix + "_full.dot"
	fileNameDotFlat := GetAptomiObjectWriteDir(GetAptomiBaseDir(), TypeGraphics) + "/graph_" + suffix + "_flat.dot"
